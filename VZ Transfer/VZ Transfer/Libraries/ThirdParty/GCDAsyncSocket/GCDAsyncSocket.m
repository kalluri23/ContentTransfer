...
- (BOOL)acceptOnInterface:(NSString *)inInterface port:(uint16_t)port error:(NSError **)errPtr
{
    ...
    dispatch_block_t block = ^{ @autoreleasepool {
        ...
        enableIPv4 = !isIPv4Disabled && (interface4 != nil);
        enableIPv6 = !isIPv6Disabled && (interface6 != nil);
...
#pragma clang diagnostic warning "-Wimplicit-retain-self"
                //                id test = [SocketManager sharedInstance].listenOnPortDelegate;
                //                id test2 = [SocketManager sharedInstance].asyncSocketDelegate;
