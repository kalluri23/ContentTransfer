...
#import "CTMVMLeftRightTextButtonHeaderFooterView.h"
#import "CTMVMButtons.h"
#import "CTMVMStyler.h"

@implementation CTMVMLeftRightTextButtonHeaderFooterView
...
- (void)setupView {
    ...
    if (!self.leftButton) {
        ...
        UIButton *leftButton = [CTMVMButtons primaryLinkButon:nil constrainHeight:YES];
        leftButton.translatesAutoresizingMaskIntoConstraints = NO;
        [self.contentView addSubview:leftButton];
        self.leftButton = leftButton;
        
        UIButton *rightButton = [CTMVMButtons primaryLinkButon:nil constrainHeight:YES];
        rightButton.translatesAutoresizingMaskIntoConstraints = NO;
        [self.contentView addSubview:rightButton];
        self.rightButton = rightButton;
            
        NSDictionary *horizontalMetrics = @{@"horizontal":@(CT_STANDARD_SMALL_BUFFER)};
